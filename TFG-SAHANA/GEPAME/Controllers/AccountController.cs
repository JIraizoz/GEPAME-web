...
namespace GEPAME.Controllers
{
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Register([FromBody] Usuario Credentials)
        {
            if (ModelState.IsValid)
            {
                var user = new IdentityUser(Credentials.Username);
        ...
        [HttpPost]
        public async Task<IActionResult> SignIn([FromBody] Usuario Credentials)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            var payload = new Dictionary<string, object> { { "id", user.Id }, { "sub", user.Email }, { "email", user.Email }, { "emailConfirmed", user.EmailConfirmed }, };
